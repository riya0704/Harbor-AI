    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Start managing your social media today</p>
        </div>
                ...
                <div className="mt-3 space-y-2">
                  ...
                  <div className="grid grid-cols-1 gap-1 text-xs">
                    <div className={`flex items-center ${passwordRequirements.length ? 'text-green-600' : 'text-gray-400'}`}>
                      <Check className={`h-3 w-3 mr-2 ${passwordRequirements.length ? 'text-green-600' : 'text-gray-300'}`} />
                      At least 8 characters
                    </div>
                    <div className={`flex items-center ${passwordRequirements.uppercase ? 'text-green-600' : 'text-gray-400'}`}>
                      <Check className={`h-3 w-3 mr-2 ${passwordRequirements.uppercase ? 'text-green-600' : 'text-gray-300'}`} />
                      One uppercase letter
                    </div>
                    <div className={`flex items-center ${passwordRequirements.lowercase ? 'text-green-600' : 'text-gray-400'}`}>
                      <Check className={`h-3 w-3 mr-2 ${passwordRequirements.lowercase ? 'text-green-600' : 'text-gray-300'}`} />
                      One lowercase letter
                    </div>
                    <div className={`flex items-center ${passwordRequirements.number ? 'text-green-600' : 'text-gray-400'}`}>
                      <Check className={`h-3 w-3 mr-2 ${passwordRequirements.number ? 'text-green-600' : 'text-gray-300'}`} />
                      One number
                    </div>
                    <div className={`flex items-center ${passwordRequirements.special ? 'text-green-600' : 'text-gray-400'}`}>
                      <Check className={`h-3 w-3 mr-2 ${passwordRequirements.special ? 'text-green-600' : 'text-gray-300'}`} />
